...
function SignInComponent() {
    ...
    container.setAttribute("class", "d-flex justify-content-center align-items-center");

    let signInForm = document.createElement("div");
    signInForm.setAttribute("style", "width:30%; height:400px; box-shadow: 10px 10px 10px grey");
    container.appendChild(signInForm);

    let heading = document.createElement("h3");
    heading.innerText = "Sign In";
    heading.setAttribute("style", "display: block; text-align: center;margin-top: 20px;");
    signInForm.appendChild(heading);

    let userName = document.createElement("lable");
    userName.innerHTML = "Email";
    userName.setAttribute("style", "display: block; text-align: left; font-weight: bold; margin-top: 20px;");
    signInForm.appendChild(userName);

    let userNameInput = document.createElement("input");
    userNameInput.setAttribute("type", "email");
    userNameInput.setAttribute("placeholder", "Enter Email");
    userNameInput.setAttribute("style", "width:95%;border: 1px solid black;padding:8px;");
    signInForm.appendChild(userNameInput);

    let password = document.createElement("lable");
    password.innerHTML = "Password";
    password.setAttribute("style", "display: block; text-align: left; font-weight: bold; margin-top: 20px;");
    signInForm.appendChild(password);

    let passwordInput = document.createElement("input");
    passwordInput.setAttribute("type", "password");
    passwordInput.setAttribute("placeholder", "Enter Password");
    passwordInput.setAttribute("style", "width:95%;border: 1px solid black;padding:8px;");
    signInForm.appendChild(passwordInput);

    let br = document.createElement("br");
    signInForm.appendChild(br);

    let text = document.createElement("lable");
    text.innerHTML = "Forgot Password";
    text.setAttribute("style", "display: flex;text-align: right;color:blue");
    signInForm.appendChild(text);

    let submitbtn = document.createElement("button");
    submitbtn.innerHTML = "Submit";
    submitbtn.setAttribute("type", "button");
    submitbtn.setAttribute("style", "width:100px;border:1px solid black;margin-top: 30px;margin-left: 70px;background:green");
    submitbtn.onclick = function () {
        ...
        let validUser = existingUser.find(user => user.email === NameValue && user.password === PasswordValue);
    ...
    cancelbtn.setAttribute("style", "width:100px;border:1px solid black;margin-top: 30px;margin-left:15px;background:red");
    cancelbtn.onclick = function () {
        signInForm.remove();
    }
    signInForm.appendChild(cancelbtn);

    let paragraph = document.createElement("p");
    paragraph.setAttribute("style", "margin-left:70px;margin-top:20px")
    ...
    paragraph.appendChild(signupLink);
...
function SignUpComponent() {
    ...
    signUpForm.setAttribute("style", "width:30%; height:400px; box-shadow: 10px 10px 10px grey;");
    container.appendChild(signUpForm);

    let heading = document.createElement("h3");
    heading.innerText = "Sign Up";
    heading.setAttribute("style", "display: block; text-align: center");
    signUpForm.appendChild(heading);

    let Name = document.createElement("lable");
    Name.innerHTML = "Name";
    Name.setAttribute("style", "display: block; text-align: left; font-weight: bold; margin-top: 20px;");
    signUpForm.appendChild(Name);

    let NameInput = document.createElement("input");
    NameInput.setAttribute("type", "text");
    NameInput.setAttribute("placeholder", "Enter Your Name");
    NameInput.setAttribute("style", "width:95%;border: 1px solid black;padding:8px;");
    ...
    emailInput.setAttribute("style", "width:95%;border: 1px solid black;padding:8px;");
...
function ViewMoreComponent(product) {
    ...
    productDetailsContainer.appendChild(availabilityStatus);
     ...
     price.innerHTML = '<b>Prise : </b>'+`<label class='text-success'>${product.price} Rs.</label>`;
    ...
    let ratingStatus = document.createElement("p");
    ratingStatus.innerHTML = "<b>Rating : </b> " + product.rating;
    productDetailsContainer.appendChild(ratingStatus);

    let buyNow = document.createElement("button");
    buyNow.setAttribute("class", "btn btn-warning");
    buyNow.innerText = "Buy now";
    buyNow.setAttribute("style", "width:100%");
    buyNow.addEventListener("click",function checkUserAndbyNow() {
